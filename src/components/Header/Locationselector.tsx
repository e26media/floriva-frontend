  ...
  useEffect(() => {
    ...
    fetch(`${BASE_URL}/api/allCountries`)
      ...
      .then((json) => {
        ...
        setCountries(data)
        if (data.length > 0 && !selectedCountry) setSelectedCountry(data[0])
      })
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .max-h-64::-webkit-scrollbar-thumb        { background: #c1c1c1; border-radius: 10px; }
        .max-h-64::-webkit-scrollbar-thumb:hover  { background: #a8a8a8; }
      `}</style>
    </div>
  )
}
  ...
  return (
    <>
      ...
      >
        ...
        {/* Sub-label (unselected state only) */}
        {!selected && (
